...
class TransactionServiceTest {
    ...
    void successUseBalance() {
        ...
        //when
        TransactionDto transactionalDto = transactionService.useBalance(1L, "1000000000", USE_AMOUNT);
        //then
    ...
    void successCancelBalance() {
        ...
        //when
        TransactionDto transactionalDto = transactionService.cancelBalance(
    ...
    void successQueryTransaction() {
        ...
        given(transactionRepository.findByTransactionId(anyString()))
                .willReturn(Optional.of(transaction));
        //when
        TransactionDto transactionalDto = transactionService.queryTransaction("trxId");
        //then
        assertEquals(USE, transactionalDto.getTransactionType());
        assertEquals(S, transactionalDto.getTransactionResultType());
